...
IUCORE_DLLAPI void setValue(const half_float::half& value, VolumeCpu_16f_C1* srcdst, const IuCube& roi);
IUCORE_DLLAPI void setValue(const float16_2& value, VolumeCpu_16f_C2* srcdst, const IuCube& roi);
IUCORE_DLLAPI void setValue(const float16_4& value, VolumeCpu_16f_C4* srcdst, const IuCube& roi);
