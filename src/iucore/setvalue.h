...
//extern IuStatus cuSetValue(const short&  value, iu::VolumeGpu_16u_C1 *dst, const IuCube &roi);
//extern IuStatus cuSetValue(const short2& value, iu::VolumeGpu_16u_C2 *dst, const IuCube &roi);
//extern IuStatus cuSetValue(const short4& value, iu::VolumeGpu_16u_C4 *dst, const IuCube &roi);
