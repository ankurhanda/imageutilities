...
void setValue(const half_float::half &value, VolumeCpu_16f_C1* srcdst, const IuCube& roi)
{iuprivate::setValue(value, srcdst, roi);}

void setValue(const float16_2 &value, VolumeCpu_16f_C2* srcdst, const IuCube& roi)
{iuprivate::setValue(value, srcdst, roi);}

void setValue(const float16_4 &value, VolumeCpu_16f_C4* srcdst, const IuCube& roi)
{iuprivate::setValue(value, srcdst, roi);}
...
void convert_32f8u_C4(const iu::ImageGpu_32f_C4* src, const IuRect& src_roi, iu::ImageGpu_8u_C4* dst, const IuRect& dst_roi,
                     float mul_constant, unsigned char add_constant)
{iuprivate::convert_32f8u_C4(src, src_roi, dst, dst_roi, mul_constant, add_constant);}
